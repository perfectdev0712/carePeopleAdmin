...
import { updateWorkers } from "../../redux/actions/user/index"
import { status_options, worker_status_options } from "../../configs/providerconfig"
...
class DataListSidebar extends Component {
	...
	handleregister = e => {
		e.preventDefault();
		this.props.updateWorkers(this.state.userData, this.props.dataParams, this.props.condition);
							...
							<Col md="4" sm="12">
								<FormGroup className="mb-0">
									...
									<Select
										...
										value={worker_status_options.find(obj => obj.value === userData.work_status)}
										defaultValue={worker_status_options[0]}
										onChange={e => this.updateUserData('work_status', e.value)}
									/>
								</FormGroup>
							</Col>
						</Row>
...
export default connect(null, { updateWorkers })(DataListSidebar);