...
import { getAllClients } from "../../redux/actions/user/index";
...
class ListViewConfig extends Component {
	...
	componentDidMount() {
		this.props.getAllClients(this.props.parsedFilter, this.state.condition);
	}
	...
	handleRowsPerPage = value => {
		let { parsedFilter, getAllClients } = this.props;
		let page = parsedFilter.page ? parsedFilter.page : 1
		history.push(`${history.location.pathname}?page=${page}&perPage=${value}`);
		this.setState({ rowsPerPage: value })
		getAllClients({ page, perPage: value }, this.state.condition);
	}
	...
	handlePagination = page => {
		...
		getAllClients({ page: page.selected + 1, perPage }, this.state.condition);
	}
	...
	handleFilter = (value, bool) => {
		...
		this.props.getAllClients(this.props.parsedFilter, condition);
	}
